/*DescripciÃ³n de problema:  Escribir una funciÃ³n Salario que calcule los salarios de un trabajador para un nÃºmero dado de horas trabajadas y un salario hora.
Las horas que superen las 40 horas semanales se pagarÃ¡n como extras con un salario hora 1,5 veces el salario ordinario. AsÃ­ mismo se deberÃ¡ calcular el monto a pagar de IGSS por cada trabajador.

El programa debera contener un menu para:
1) Invocar dicha funcion y grabar datos a un archivo,
2) Adicionalmente deberÃ¡ tener una opciÃ³n para leer el archivo y grabar los datos en memoria. 
3) Una opciÃ³n para mostrar cuanto se paga de total de planilla e IGSS.*/
